...
#define M3_OUTA_Pin GPIO_PIN_0
#define M3_OUTA_GPIO_Port GPIOB
#define M3_OUTB_Pin GPIO_PIN_1
#define M3_OUTB_GPIO_Port GPIOB
#define RIGHT_LINE_OUT_Pin GPIO_PIN_2
#define RIGHT_LINE_OUT_GPIO_Port GPIOB
#define RIGHT_LINE_OUT_EXTI_IRQn EXTI2_IRQn
...
#define RGB2_INT_Pin GPIO_PIN_4
#define RGB2_INT_GPIO_Port GPIOB
#define RGB2_INT_EXTI_IRQn EXTI4_IRQn
#define RGB1_INT_Pin GPIO_PIN_5
#define RGB1_INT_GPIO_Port GPIOB
#define RGB1_INT_EXTI_IRQn EXTI9_5_IRQn
